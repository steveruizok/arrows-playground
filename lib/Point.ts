...
class Point extends Pixi.Point {
  ...
  setFomInteractionEvent(e: Pixi.InteractionEvent) {
    this.set(e.data.global.x, e.data.global.y)
  }
  ...
  static fromInteractionEvent(e: Pixi.InteractionEvent) {
    return new Point(e.data.global.x, e.data.global.y)
  }
